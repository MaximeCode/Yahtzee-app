...
export function ScoreTable1({ scores, points, onclickAddPts, calcSubtotal, calcBonus, calcUpperTotal }) {

  const initialClickedCase = Array(6).fill(false);
